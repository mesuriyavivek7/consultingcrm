...
import type { AccountManagerCallAnalytics } from "@/services/account-manager.service";
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Line
              ...
              stroke="#556ee6"
              strokeWidth={3}
              dot={{ r: 5, fill: "#556ee6", strokeWidth: 2, stroke: "#fff" }}
              activeDot={{ r: 7, fill: "#556ee6", stroke: "#fff", strokeWidth: 3 }}
            />
          </LineChart>
        </ResponsiveContainer>
      </div>
