import type { TodaysOverview } from "@/services/account.service";
...
export default function AccountCallSummaryCard({ overview }: CallSummaryCardProps) {
  const {
    todaysTotalCalls,
    progressPercentage,
  ...
  return (
    <div className="flex-1 rounded-xl bg-white p-4 shadow-sm md:p-5">
      ...
      <p className="mt-0.5 text-xs text-[#8a92a6]">Your calls for the current day</p>
