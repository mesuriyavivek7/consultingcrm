...
import type { CallAnalytics } from "@/services/account.service";
...
export default function AccountCallAnalyticsChart({ callAnalytics }: CallAnalyticsChartProps) {
    ...
    <div className="flex-1 rounded-xl bg-white p-4 shadow-sm md:p-6">
      <div className="mb-5 flex items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-[#3a4050]">My Call Analytics</h2>
        </div>
