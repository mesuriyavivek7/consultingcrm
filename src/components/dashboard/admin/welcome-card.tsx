...
export default function WelcomeCard({ adminProfile }: WelcomeCardProps) {
  const { fullName, email, mobileNo } = adminProfile;
    ...
    <div className="rounded-xl bg-white shadow-sm">
      ...
      <div className="relative rounded-t-xl bg-[#c8cff8] px-5 pb-8 pt-5">
        <div>
          ...
          <p className="mt-0.5 text-sm text-[#6b7fcc]">Admin Dashboard</p>
        </div>
      ...
      <div className="px-5 pb-6 pt-2 space-y-1.5">
        ...
        <p className="text-xs text-[#8a92a6]">Administrator</p>
