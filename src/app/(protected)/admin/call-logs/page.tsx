        ...
        <tr key={log._id} className="transition-colors hover:bg-[#f8fafd]">
          ...
          <td className="px-5 py-3.5">
            <div className="flex items-center gap-3">
              <Avatar
                firstName={log.calledBy.firstName}
                lastName={log.calledBy.lastName}
              />
              <div className="min-w-0">
                <p className="truncate text-sm font-medium text-[#3a4050]">
                  {log.calledBy.firstName} {log.calledBy.lastName}
                </p>
                <p className="truncate text-xs text-[#8a92a6]">
                  {log.calledBy.uniqueId}
                </p>
              </div>
            </div>
          </td>
    ...
    <main className="flex min-h-[calc(100vh-4rem)] flex-col p-4 sm:p-6 md:p-8">
      ...
      <div className="mb-5">
        <div className="mb-0.5 flex items-center gap-2">
          ...
          <h1 className="text-xl font-semibold text-[#3a4050]">Call Logs</h1>
        </div>
        <p className="text-sm text-[#8a92a6]">
          View and filter all call activity in the system.
        </p>
      </div>
            ...
            <table className="w-full min-w-[860px] text-sm">
              ...
              <thead>
                <tr className="border-b border-[#eef2f8] bg-[#f8fafc]">
                  ...
                  <th className="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-[#6b7280]">Caller</th>
