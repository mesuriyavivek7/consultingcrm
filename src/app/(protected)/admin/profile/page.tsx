...
/* ─── Sub-component: Change Password Dialog ─── */
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                type="submit"
                disabled={isPending}
                className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#556ee6] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#4a5fd4] disabled:opacity-60"
              >
                {isPending ? (
                  <>
              ...
              <form onSubmit={handleSubmit(onSubmit)} noValidate>
                ...
                <div className="flex justify-end border-t border-[#f3f4f6] px-6 py-4">
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl bg-[#556ee6] px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-[#4a5fd4] disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    {isSaving ? (
                      <>
                        <Loader2 size={15} className="animate-spin" />
